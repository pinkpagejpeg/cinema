...
export const ActorsSlider: FC<any> = ({ id }) => {
    ...
    useEffect(() => {
        const fetchActorsData = async () => {
            try {
                ...
                dispatch(fetchActorsError('При получении информации об актерах фильма произошла ошибка'))
            }
        };
    ...
    return (
        <Stack>
            ...
            {actorsLoading !== null && actorsLoading !== false && <Text c="dimmed">Загрузка информации об актерах...</Text>}
            {actors !== null ?
                <>
                    <Grid>
                        <Grid.Col span={6}>
